...
class ciCalculatorPage extends StatefulWidget {
  const ciCalculatorPage({Key? key}) : super(key: key);

  @override
  State<ciCalculatorPage> createState() => ciCalculatorPageState();
}

class ciCalculatorPageState extends State<ciCalculatorPage> {
  ...
  void calculateTotalValue() {
    ...
    double r = double.parse(estimatedReturnController.text) / 100;
